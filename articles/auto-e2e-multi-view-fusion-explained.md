...
以下、各計算が何をしているのか、なぜ必要なのかを順に追っていきます。

#### BEV Queries — 各 BEV セルの「問い合わせベクトル」
...
#### 3D Reference Points — 「どこの情報を取りに行くか」の座標
...
#### カメラパラメータによる 3D → 2D 投影 — 「3D点がカメラのどこに映るか」
...
#### Sampling Offsets — 投影先を微調整する学習可能なずらし
