...
これまで Tesla さんとかがE2Eに移行していますよと言っても、Pure な Transformer （いわゆるDeepでぽん）で直接的に経路出力というのはなかなか精度が出ないというのが数年前からわかっていました。
...
どういうモデル構成にするとうまくできるのかが不思議だったんですが、UniAD というフレームワークはTesla さんのAI Day で出てる HydraNet の考え方を踏襲しながら単一のモデルをで実現していて、私も初めてこの論文に出会った時は、非常に大きな感銘を受けたものです。
...
<img width="950" alt="image" src="https://github.com/user-attachments/assets/9b999be6-fc95-4f16-8f01-1841fc2a116f">
